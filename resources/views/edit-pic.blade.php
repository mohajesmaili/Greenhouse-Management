      ...
      <section id="main-content">
          <section class="wrapper">
                  ...
                  <div class="form-panel">
                      <h4 class="mb">ویرایش تصاویر</h4>
                      <form class="form-horizontal style-form" method="post" action="../{{$query->id}}" name="form" onsubmit="return validateForm();" enctype="multipart/form-data">
                          {{csrf_field()}}
                          {{method_field("put")}}
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">نام :</label>
                              <div class="col-sm-10" style="margin-right: -100px;">
                                  <input id="name" name="name" class="form-control round-form" type="text" placeholder="نام" value="{{$query->name}}"/>
                              </div>
                          </div>
